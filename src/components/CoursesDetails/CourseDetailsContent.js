...
import useCourseDetailsQuery from '../../queries/course-details';
...
const CourseDetailsContent = () => {
    ...
    const { markdownRemark } = useCourseDetailsQuery();
                      ...
                      <div className="courses-details-desc">
                          ...
                          <div className="tab-content">
                              <div id="tab1" className="tab-pane tabs_item">
                                  <div className="courses-overview" dangerouslySetInnerHTML={{__html: markdownRemark.html}}></div>
                              </div>
